...
#
# Same as iteration 3: RandomForestClassifier with config-driven hyperparameters.
# Iteration 4 changes only the hyperparameter values (in config.yaml), not the code.
...
def train_model(
    ...
    model = RandomForestClassifier(
        ...
        min_samples_leaf=int(hp.get("min_samples_leaf", 15)),
        min_samples_split=int(hp.get("min_samples_split", 30)),
