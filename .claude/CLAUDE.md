...
**Primary user:** Jose
**Active milestone:** M9 — Orchestrator Skill (in progress)
...
- `artifact-contracts.md` — unconditional; 6 artifact schema contracts (profile.json, iteration YAML, run-history, model-report, iteration code outputs, execution artifacts) ✅ (M0.4, M4, M5, M6, M7)
